...
<label className="font-semibold text-sm text-gray-600 pb-1 block">Edit Driver</label>
<select
id="driver"
name="driver"
                        value={driver}
...
<label className="font-semibold text-sm text-gray-600 pb-1 block">Edit Delivery Date</label>
...
<label className="font-semibold text-sm text-gray-600 pb-1 block">Edit Order ID</label>
<input  id="orderid" name="orderid" value={orderid} onChange={onChange} type="text" className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" />
 

<label className="font-semibold text-sm text-gray-600 pb-1 block">Edit Status</label>
